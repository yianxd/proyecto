...
def menu_cuenta():
    ...
    while True:
        ...
        if eleccion == 1:
            ...
            archivo.write("Id de la cuenta: ")
            archivo.write(str(id_cue))
            archivo.write("\n")
            archivo.write("Id del usuario: ")
            archivo.write(str(id_usu))
            archivo.write("\n")
            archivo.write("Id del servicio: ")
            archivo.write(str(id_ser))
            archivo.write("\n")
            archivo.write("Ingrese el costo extra: ")
            archivo.write(str(costo_ext))
            archivo.write("\n")
            archivo.close()
            ...
            archivo.write(str(Id))
            archivo.write("\n")
            archivo.write("Extras costos: ")
            archivo.write(str(Extra))
            archivo.write("\n")
            archivo.close()
